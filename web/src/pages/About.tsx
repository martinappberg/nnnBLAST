    ...
    <main className="max-w-4xl mx-auto px-6 py-10 space-y-16">
      ...
      <section className="text-center space-y-4">
        <h1 className="text-4xl font-bold text-[#1C1917]">
          ...
          <span className="text-[#B4637A]">BLAST</span>?
        </h1>
        ...
        <div className="flex justify-center gap-3 pt-2">
          <Link
            to="/"
            className="inline-flex items-center gap-2 bg-[#B4637A] text-white px-6 py-2.5 rounded-xl font-semibold hover:bg-[#9B4D63] transition-colors shadow-sm"
          >
            Try a search
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-4">
          {PIPELINE_STEPS.map((step, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl border border-[#F0DDE3] p-5 text-center space-y-2 shadow-sm hover:shadow-md transition-shadow"
            >
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#FFF0F3] text-[#B4637A]">
                {step.icon}
              </div>
              <div className="text-xs font-bold text-[#B4637A] uppercase tracking-wider">
                Step {step.step}
              </div>
      ...
      <section className="space-y-6">
        ...
        <div className="bg-[#FAF0F0] rounded-2xl p-5 font-mono text-sm border border-[#F0DDE3]">
          <span className="text-[#B4637A] font-bold">MOTIF1</span>
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {SYNTAX_TABLE.map((row, i) => (
                <tr
                  key={i}
                  className="border-b border-[#F0DDE3] hover:bg-[#FFF0F3] transition-colors"
                >
      ...
      <section className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-[#F0DDE3] p-6 space-y-4 shadow-sm">
          <div className="bg-[#FAF0F0] rounded-xl p-4 font-mono text-center text-lg border border-[#F0DDE3]">
            {"E = N"}
            <sub>eff</sub>
            {" \u00D7 \u220F W"}
            <sub>i</sub>
      ...
      <section className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-[#F0DDE3] p-6 space-y-4 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="bg-[#FFF8F6] rounded-xl p-4 space-y-2 border border-[#F0DDE3]">
              <div className="font-semibold text-[#B4637A]">Motif 1 (19bp)</div>
            ...
            <div className="bg-[#FFF8F6] rounded-xl p-4 space-y-2 border border-[#F0DDE3]">
              <div className="font-semibold text-[#B4637A]">Motif 2 (20bp)</div>
          ...
          <div className="bg-[#FAF0F0] rounded-xl p-4 space-y-2 text-sm border border-[#F0DDE3]">
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="border-b-2 border-[#F0DDE3] text-left">
                ...
                <th className="py-2 px-3 text-[#B4637A] font-semibold">nnnBLAST</th>
            ...
            <tbody>
              {COMPARISON_TABLE.map((row, i) => (
                ...
                >
                  ...
                  <td className="py-2 px-3 text-[#B4637A] font-medium">
                    {row.nnnblast}
                  </td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {INTERACTIVE_EXAMPLES.map((example, i) => (
            <Link
              ...
              className="group bg-white rounded-2xl border border-[#F0DDE3] p-5 space-y-3 shadow-sm hover:shadow-md hover:border-[#B4637A] transition-all"
            >
              <div className="font-semibold text-[#1C1917] group-hover:text-[#B4637A] transition-colors">
                {example.title}
              </div>
              <p className="text-xs text-[#57534E] leading-relaxed">
                {example.description}
              </p>
              <div className="flex items-center gap-1 text-xs font-semibold text-[#B4637A]">
                Try this query
